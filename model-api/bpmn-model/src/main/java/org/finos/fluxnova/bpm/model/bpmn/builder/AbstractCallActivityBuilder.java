...
public class AbstractCallActivityBuilder<B extends AbstractCallActivityBuilder<B>> extends AbstractActivityBuilder<B, CallActivity> {
   ...
   * @return the builder object
   */
  public B fluxnovaCalledElementBinding(String camundaCalledElementBinding) {
    element.setFluxnovaCalledElementBinding(camundaCalledElementBinding);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaCalledElementVersion(String camundaCalledElementVersion) {
    element.setFluxnovaCalledElementVersion(camundaCalledElementVersion);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaCalledElementVersionTag(String camundaCalledElementVersionTag) {
    element.setFluxnovaCalledElementVersionTag(camundaCalledElementVersionTag);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaCalledElementTenantId(String camundaCalledElementTenantId) {
    element.setFluxnovaCalledElementTenantId(camundaCalledElementTenantId);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaCaseRef(String caseRef) {
    element.setFluxnovaCaseRef(caseRef);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaCaseBinding(String camundaCaseBinding) {
    element.setFluxnovaCaseBinding(camundaCaseBinding);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaCaseVersion(String camundaCaseVersion) {
    element.setFluxnovaCaseVersion(camundaCaseVersion);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaCaseTenantId(String tenantId) {
    element.setFluxnovaCaseTenantId(tenantId);
    return myself;
  }
   ...
   * @return the builder object
   */
  public B fluxnovaInBusinessKey(String businessKey) {
    FluxnovaIn param = modelInstance.newInstance(FluxnovaIn.class);
    param.setFluxnovaBusinessKey(businessKey);
  ...
  public B fluxnovaVariableMappingClass(Class camundaVariableMappingClass) {
    return fluxnovaVariableMappingClass(camundaVariableMappingClass.getName());
  }
   ...
   * @return                              the builder object
   */
  public B fluxnovaVariableMappingClass(String fullQualifiedClassName) {
    element.setFluxnovaVariableMappingClass(fullQualifiedClassName);
    return myself;
  }
   ...
   * @return                              the builder object
   */
  public B fluxnovaVariableMappingDelegateExpression(String camundaVariableMappingDelegateExpression) {
    element.setFluxnovaVariableMappingDelegateExpression(camundaVariableMappingDelegateExpression);
    return myself;
  }
}
