 ...
 */
public class FluxnovaInImpl extends BpmnModelElementInstanceImpl implements FluxnovaIn {
  ...
  public static void registerType(ModelBuilder modelBuilder) {
    ModelElementTypeBuilder typeBuilder = modelBuilder.defineType(FluxnovaIn.class, CAMUNDA_ELEMENT_IN)
      ...
      .instanceProvider(new ModelTypeInstanceProvider<FluxnovaIn>() {
        public FluxnovaIn newInstance(ModelTypeInstanceContext instanceContext) {
          return new FluxnovaInImpl(instanceContext);
        }
      });
  ...
  public FluxnovaInImpl(ModelTypeInstanceContext instanceContext) {
  ...
  public String getFluxnovaBusinessKey() {
    return camundaBusinessKeyAttribute.getValue(this);
  }

  public void setFluxnovaBusinessKey(String camundaBusinessKey) {
