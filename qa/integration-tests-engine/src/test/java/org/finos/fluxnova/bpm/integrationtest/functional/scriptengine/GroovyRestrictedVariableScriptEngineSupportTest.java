...
public class GroovyRestrictedVariableScriptEngineSupportTest
    extends AbstractRestrictedVariableScriptEngineSupportTest {

  protected static final String SCRIPT_FORMAT = "groovy";

  protected static final String RESTRICTED_CREATE_SCRIPT =
      "def options = new org.finos.fluxnova.bpm.engine.variable.VariableOptions(false, true, false)\n"
