...
import org.finos.fluxnova.bpm.engine.impl.AuthorizationQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.DeploymentQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.DeploymentStatisticsQueryImpl;
...
import org.finos.fluxnova.bpm.engine.impl.HistoricDecisionInstanceQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.HistoricDetailQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.HistoricExternalTaskLogQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.HistoricIdentityLinkLogQueryImpl;
...
import org.finos.fluxnova.bpm.engine.impl.IncidentQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.JobDefinitionQueryImpl;
...
import org.finos.fluxnova.bpm.engine.impl.UserOperationLogQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.VariableInstanceQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.batch.BatchQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.batch.BatchStatisticsQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.batch.history.HistoricBatchQueryImpl;
...
import org.finos.fluxnova.bpm.engine.impl.db.PermissionCheckBuilder;
import org.finos.fluxnova.bpm.engine.impl.db.entitymanager.operation.DbOperation;
import org.finos.fluxnova.bpm.engine.impl.dmn.entity.repository.DecisionDefinitionQueryImpl;
import org.finos.fluxnova.bpm.engine.impl.dmn.entity.repository.DecisionRequirementsDefinitionQueryImpl;
...
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.util.AuthManagerUtil;
import org.finos.fluxnova.bpm.engine.impl.persistence.entity.util.AuthManagerUtil.VariablePermissions;
...
public class AuthorizationManager extends AbstractManager {
   ...
   */
  public void checkFluxnovaAdmin() {
    final Authentication currentAuthentication = getCurrentAuthentication();

    if (isAuthorizationEnabled() && getCommandContext().isAuthorizationCheckEnabled()
        && currentAuthentication != null && !isFluxnovaAdmin(currentAuthentication)) {

      throw LOG.requiredFluxnovaAdmin();
    }
  }

  public void checkFluxnovaAdminOrPermission(Consumer<CommandChecker> permissionCheck) {
    if (isAuthorizationEnabled() && getCommandContext().isAuthorizationCheckEnabled()) {
      ...
      if (authorizationException != null && adminException != null) {
        ...
        throw LOG.requiredFluxnovaAdminOrPermissionException(info);
      }
    }
  }
   ...
   */
  public boolean isFluxnovaAdmin(Authentication authentication) {
